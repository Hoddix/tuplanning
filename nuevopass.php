...
<body>
            ...
            <div id="contenidoseccion">
                <div id="registro">
                    ...
                    <form id="formulario" action="php/funciones.php" method="post" accept-charset="utf-8">
                        ...
                        <input class="text-class imagen cien" id="ipassword" type="password" name="ipassword" placeholder="Nueva contraseña" onfocus="colorInputText('ipassword');"><br/>
                        <div class="text-class-icon-cien" id="rpassword">&nbsp;</div>
                        <input class="text-class imagen cien" id="irpassword" type="password" name="irpassword" placeholder="Repetir nueva contraseña" onfocus="colorInputText('irpassword');"><br/>
                        <input class="btn-class bazul" type="submit" id="enviar" name="cambiarpass" value="Cambiar contraseña">
                    </form>
                </div>
            </div>
        </section>
    ...
    <script type="text/javascript">
        //JS del framework de estilos
        var framew = framework.objframework;
        //Verificaion de campos de texto
        var objPass = formularioNuevoPass.objCambiarPass;
        objPass.cargarEventosPass();
