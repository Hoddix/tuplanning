...
<body>
    <div class="contenido">
        <header>
            <!-- Menu de las paginas en las que no incias sesion -->
            ...
            <div id="login">
                ...
                <?php 
                    //Iniciamos sesion
                    session_start();
                    //Controlamos que el usuario meta bien los datos de login y en el caso contrario mostramos un mensaje de error
        ...
        <section>
            <div id="contenidoseccion">
                <div id="registro">
                    ...
                    <h2>Escriba el email de la cuenta que quiere recuperar la contraseña.</h2>
                    <!-- Formulario para el email donde nos enviaran el password -->
                    <form id="formulario" action="php/funciones.php" method="post" accept-charset="utf-8">
                        <div class="text-class-icon-cien" id="email">&nbsp;</div>
                        <input class="text-class imagen cien" id="iemail" type="text" name="email" placeholder="Email" onfocus="colorInputText('iemail');"><br/>
                        <input class="btn-class bazul" type="submit" id="enviar" name="recuperarpass" value="Enviar email">
                    </form>
                </div>
            </div>
        </section>
    ...
    <script type="text/javascript">
        ...
        //Comprobamos el campo del email 
        var objRecupearPass = formularioRecuperarPass.objRecPass;
        objRecupearPass.cargarEventos();
        //Fondo aleatorio
