    ...
    <div class="contenido-calendario">
        <header>
			...
			<ul>
			   ...
			   <li class='has-sub'><a href='javascript:print'><img src="images/logout.png"></a></li>
		        ...
		        <form id="formulario" action="php/funciones.php" method="post" accept-charset="utf-8">
					...
					<div>
					    ...
					    <?php 
					    	...
					    	if(!empty($result)){
					    		echo '<div>';	
					    		echo '<div class="colores-etiquetas-creadas" id="colord" style="background:#5593ca  url(\'images/glossy.png\')0px -1px;" onclick="getColorEtiquetaCreada(\'colorelegido\',this.id,\'#5593ca\')">Etiqueta por defecto</div>';
						    	for($i=0;$i<count($result);$i++){				    				
				    				echo '<div class="colores-etiquetas-creadas" id="color'.$i.'" style="background:'.$result[$i]['color'].' url(\'images/glossy.png\')0px -1px;" onclick="getColorEtiquetaCreada(\'colorelegido\',this.id,\''.$result[$i]['color'].'\')">'.$result[$i]['etiqueta'].'</div>';				    				
				    			}
					    		...
					    		echo '<div class="colores-etiquetas-creadas" id="colord" style="background:#5593ca;" onclick="getColorEtiquetaCreada(\'colorelegido\',this.id,\'#5593ca\')">Etiqueta por defecto</div>';
					    		echo '<input type="hidden" name="coloreti" id="colorelegido" value="#5593ca">';
